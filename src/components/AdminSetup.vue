<template lang="html">
  <div class="admin center card-panel">
    ...
    <button class="btn red" @click="assignInitialTargets">Assign Initial Teams</button>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    createTeamObjects() {
      //Create team objects to be updated in Firebase based on team number
    ...
    assignInitialTargets() {
      ...
      // Create 4 arrays with the 4 dynasty Teams
